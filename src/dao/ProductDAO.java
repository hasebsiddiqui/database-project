...
//            }
            ...
            String q = "EXEC insertprocedure4 ?,?,?,?";
            pstmt = (PreparedStatement) con.prepareStatement(q);
            //pstmt.setString(1, productCode);
            if (productdto.getCostPrice() < productdto.getSellingPrice()) {
                JOptionPane.showMessageDialog(null, "Cost price should be less than sell price");
            } else {
...
//    addPurchaseDAO
    public void addPurchaseDAO(ProductDTO productdto) {
        try {
            String q = "INSERT INTO purchaseinfo VALUES(?,?,?,?,?)";
            pstmt = (PreparedStatement) con.prepareStatement(q);
